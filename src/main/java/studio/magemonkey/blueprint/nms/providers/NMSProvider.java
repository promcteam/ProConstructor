...
public abstract class NMSProvider {
    ...
    public final Method getMethodByNames(Class<?> clazz, String[] names, Class<?>... parameterTypes) throws
    ...
    public final Object loadNBTFromInputStream(InputStream in) {
        if (NBTCompressedStreamTools_nbtFromInputStreamMethod == null) {
            try {
                NBTCompressedStreamTools_nbtFromInputStreamMethod =
                        getMethodByNames(getClassByNames(getNBTCompressedStreamToolsNames()),
    ...
    public final Object nbtTagByte_valueOf(byte value) {
        if (nbtTagByte_valueOfMethod == null) {
            try {
                nbtTagByte_valueOfMethod = getMethodByNames(getClassByNames(getNBTTagByteClassNames()),
                        getNBTTagByte_valueOfMethodNames(),
                        byte.class);
            } catch (ClassNotFoundException | NoSuchMethodException e) {
                throw new RuntimeException(e);
            }
    ...
    public final Object newNBTTagByteArray(byte[] value) {
        if (nbtTagByteArrayConstructor == null) {
            try {
                nbtTagByteArrayConstructor =
                        getClassByNames(getNBTTagByteArrayClassNames()).getConstructor(byte[].class);
            } catch (ClassNotFoundException | NoSuchMethodException e) {
                throw new RuntimeException(e);
            }
        }
    ...
    public final double nbtTagDouble_getAsDouble(Object nbtTagDouble) {
        if (nbtTagDouble_getAsDoubleMethod == null) {
            try {
                nbtTagDouble_getAsDoubleMethod = getMethodByNames(getClassByNames(getNBTTagDoubleClassNames()),
                        getNBTTagDouble_getAsDoubleMethodNames());
            } catch (ClassNotFoundException | NoSuchMethodException e) {
                throw new RuntimeException(e);
            }
        }
    ...
    public final Object nbtTagDouble_valueOf(double value) {
        if (nbtTagDouble_valueOfMethod == null) {
            try {
                nbtTagDouble_valueOfMethod = getMethodByNames(getClassByNames(getNBTTagDoubleClassNames()),
                        getNBTTagDouble_valueOfMethodNames(),
                        double.class);
            } catch (ClassNotFoundException | NoSuchMethodException e) {
                throw new RuntimeException(e);
            }
    ...
    public final float nbtTagFloat_getAsFloat(Object nbtTagFloat) {
        if (nbtTagFloat_getAsFloatMethod == null) {
            try {
                nbtTagFloat_getAsFloatMethod = getMethodByNames(getClassByNames(getNBTTagFloatClassNames()),
                        getNBTTagFloat_getAsFloatMethodNames());
            } catch (ClassNotFoundException | NoSuchMethodException e) {
                throw new RuntimeException(e);
            }
        }
    ...
    public final Object nbtTagFloat_valueOf(float value) {
        if (nbtTagFloat_valueOfMethod == null) {
            try {
                nbtTagFloat_valueOfMethod = getMethodByNames(getClassByNames(getNBTTagFloatClassNames()),
                        getNBTTagFloat_valueOfMethodNames(),
                        float.class);
            } catch (ClassNotFoundException | NoSuchMethodException e) {
                throw new RuntimeException(e);
            }
    ...
    public final Object nbtTagInt_valueOf(int value) {
        if (nbtTagInt_valueOfMethod == null) {
            try {
                nbtTagInt_valueOfMethod = getMethodByNames(getClassByNames(getNBTTagIntClassNames()),
                        getNBTTagInt_valueOfMethodNames(),
                        int.class);
            } catch (ClassNotFoundException | NoSuchMethodException e) {
                throw new RuntimeException(e);
            }
    ...
    public final AbstractList<Object> newNBTTagList() {
        if (nbtTagListConstructor == null) {
            try {
                nbtTagListConstructor =
                        (Constructor<AbstractList<Object>>) getClassByNames(getNBTTagListClassNames()).getConstructor();
    ...
    public final Object nbtTagLong_valueOf(long value) {
        if (nbtTagLong_valueOfMethod == null) {
            try {
                nbtTagLong_valueOfMethod = getMethodByNames(getClassByNames(getNBTTagLongClassNames()),
                        getNBTTagLong_valueOfMethodNames(),
                        long.class);
            } catch (ClassNotFoundException | NoSuchMethodException e) {
                throw new RuntimeException(e);
            }
    ...
    public final Object nbtTagString_valueOf(String value) {
        if (nbtTagString_valueOfMethod == null) {
            try {
                nbtTagString_valueOfMethod = getMethodByNames(getClassByNames(getNBTTagStringClassNames()),
    ...
    public final int nbtTagCompound_getInt(Object nbtTagCompound, String key) {
        if (nbtTagCompound_getIntMethod == null) {
            try {
                nbtTagCompound_getIntMethod =
                        getMethodByNames(getNBTTagCompoundClass(), getNBTTagCompound_getIntMethodNames(), String.class);
            } catch (NoSuchMethodException e) {
                throw new RuntimeException(e);
            }
        }
    ...
    public final short nbtTagCompound_getShort(Object nbtTagCompound, String key) {
        if (nbtTagCompound_getShortMethod == null) {
            try {
                nbtTagCompound_getShortMethod = getMethodByNames(getNBTTagCompoundClass(),
                        getNBTTagCompound_getShortMethodNames(),
                        String.class);
            } catch (NoSuchMethodException e) {
                throw new RuntimeException(e);
            }
    ...
    public final int[] nbtTagCompound_getIntArray(Object nbtTagCompound, String key) {
        if (nbtTagCompound_getIntArrayMethod == null) {
            try {
                nbtTagCompound_getIntArrayMethod = getMethodByNames(getNBTTagCompoundClass(),
                        getNBTTagCompound_getIntArrayMethodNames(),
                        String.class);
            } catch (NoSuchMethodException e) {
                throw new RuntimeException(e);
            }
    ...
    public final Object nbtTagCompound_getCompound(Object nbtTagCompound, String key) {
        if (nbtTagCompound_getCompoundMethod == null) {
            try {
                nbtTagCompound_getCompoundMethod = getMethodByNames(getNBTTagCompoundClass(),
                        getNBTTagCompound_getCompoundMethodNames(),
                        String.class);
            } catch (NoSuchMethodException e) {
                throw new RuntimeException(e);
            }
    ...
    public final Object nbtTagCompound_get(Object nbtTagCompound, String key) {
        if (nbtTagCompound_getMethod == null) {
            try {
                nbtTagCompound_getMethod =
                        getMethodByNames(getNBTTagCompoundClass(), getNBTTagCompound_getMethodNames(), String.class);
            } catch (NoSuchMethodException e) {
                throw new RuntimeException(e);
            }
        }
    ...
    public final byte[] nbtTagCompound_getByteArray(Object nbtTagCompound, String key) {
        if (nbtTagCompound_getByteArrayMethod == null) {
            try {
                nbtTagCompound_getByteArrayMethod = getMethodByNames(getNBTTagCompoundClass(),
                        getNBTTagCompound_getByteArrayMethodNames(),
                        String.class);
            } catch (NoSuchMethodException e) {
                throw new RuntimeException(e);
            }
    ...
    public final Set<String> nbtTagCompound_getAllKeys(Object nbtTagCompound) {
        if (nbtTagCompound_getAllKeysMethod == null) {
            try {
                nbtTagCompound_getAllKeysMethod =
                        getMethodByNames(getNBTTagCompoundClass(), getNBTTagCompound_getAllKeysMethodNames());
            } catch (NoSuchMethodException e) {
                throw new RuntimeException(e);
            }
        }
    ...
    public final void nbtTagCompound_remove(Object nbtTagCompound, String key) {
        if (nbtTagCompound_removeMethod == null) {
            try {
                nbtTagCompound_removeMethod =
                        getMethodByNames(getNBTTagCompoundClass(), getNBTTagCompound_removeMethodNames(), String.class);
            } catch (NoSuchMethodException e) {
                throw new RuntimeException(e);
            }
        }
    ...
    public final AbstractList<Object> nbtTagCompound_getList(Object nbtTagCompound, String name, int type) {
        if (nbtTagCompound_getListMethod == null) {
            try {
                nbtTagCompound_getListMethod = getMethodByNames(getNBTTagCompoundClass(),
                        getNBTTagCompound_getListMethodNames(),
                        String.class,
                        int.class);
            } catch (NoSuchMethodException e) {
                throw new RuntimeException(e);
    ...
    public final Object nbtTagCompound_put(Object nbtTagCompound, String name, Object nbtBase) {
        if (nbtTagCompound_putMethod == null) {
            try {
                nbtTagCompound_putMethod = getMethodByNames(getNBTTagCompoundClass(),
                        getNBTTagCompound_putMethodNames(),
                        String.class,
                        getClassByNames(getNBTBaseClassNames()));
            } catch (NoSuchMethodException | ClassNotFoundException e) {
                throw new RuntimeException(e);
            }
        }
    ...
    public final void nbtTagCompound_putInt(Object nbtTagCompound, String name, int value) {
        if (nbtTagCompound_putIntMethod == null) {
            try {
                nbtTagCompound_putIntMethod = getMethodByNames(getNBTTagCompoundClass(),
                        getNBTTagCompound_putIntMethodNames(),
                        String.class,
                        int.class);
            } catch (NoSuchMethodException e) {
                throw new RuntimeException(e);
    ...
    public final Object nbtTagCompound_merge(Object nbtTagCompound, Object toMerge) {
        if (nbtTagCompound_mergeMethod == null) {
            try {
                nbtTagCompound_mergeMethod = getMethodByNames(getNBTTagCompoundClass(),
                        getNBTTagCompound_mergeMethodNames(),
        ...
        if (blockPositionConstructor == null) {
            try {
                blockPositionConstructor =
                        getClassByNames(getBlockPositionClassNames()).getConstructor(int.class, int.class, int.class);
            } catch (NoSuchMethodException | ClassNotFoundException e) {
                throw new RuntimeException(e);
            }
        }
    ...
    public final Object world_getTileEntity(World world, Object blockPosition) {
        ...
        if (world_getBlockEntityMethod == null) {
            try {
                world_getBlockEntityMethod = getMethodByNames(worldHandle.getClass(),
                        getWorld_getBlockEntityMethodNames(),
                        getClassByNames(getBlockPositionClassNames()));
            } catch (NoSuchMethodException | ClassNotFoundException e) {
                throw new RuntimeException(e);
            }
        }
    ...
    public final void world_addFreshEntityWithPassengers(World world,
                                                         Object entity,
                                                         CreatureSpawnEvent.SpawnReason spawnReason) {
        Object worldHandle = world_getHandle(world);
        if (world_addFreshEntityWithPassengersMethod == null) {
            try {
                world_addFreshEntityWithPassengersMethod = getMethodByNames(worldHandle.getClass(),
                        getWorld_addFreshEntityWithPassengersMethodNames(),
                        getClassByNames(getEntityClassNames()),
    ...
    public final void blockEntity_load(Object blockEntity, Object nbtTagCompound) {
        if (blockEntity_loadMethod == null) {
            try {
                blockEntity_loadMethod = getMethodByNames(getClassByNames(getBlockEntityClassNames()),
                        getBlockEntity_loadMethodNames(),
                        getNBTTagCompoundClass());
                ...
                try {
                    blockEntity_loadMethod = getMethodByNames(getClassByNames(getBlockEntityClassNames()),
                            getBlockEntity_loadMethodNames(),
                            getClassByNames(getIBlockDataClassNames()),
                            getNBTTagCompoundClass());
    ...
    public final Object entityType_loadEntityRecursive(Object nbtTagCompound,
                                                       World world,
                                                       Function<Object, Object> function) {
        if (entityType_loadEntityRecursiveMethod == null) {
            try {
                entityType_loadEntityRecursiveMethod = getMethodByNames(getEntityTypeClass(),
                        getEntityType_loadEntityRecursiveMethodNames(),
                        getNBTTagCompoundClass(),
                        getClassByNames(getLevelClassNames()),
                        Function.class);
            } catch (NoSuchMethodException | ClassNotFoundException e) {
                throw new RuntimeException(e);
            }
    ...
    public final void entity_absMoveTo(Object entity, double x, double y, double z, float yaw, float pitch) {
        if (entity_absMoveToMethod == null) {
            try {
                entity_absMoveToMethod = getMethodByNames(getEntityClass(),
                        getEntity_absMoveToMethodNames(),
                        double.class,
                        double.class,
                        double.class,
                        float.class,
    ...
    public final Object entity_getBukkitEntity(Object entity) {
        if (entity_getBukkitEntityMethod == null) {
            try {
                entity_getBukkitEntityMethod =
                        getMethodByNames(getEntityClass(), getEntity_getBukkitEntityMethodNames());
            } catch (NoSuchMethodException e) {
                throw new RuntimeException(e);
            }
        }
