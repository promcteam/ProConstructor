...
public class TileChecker_1_17_R1 implements TileChecker {
	...
	public void check(EmptyBuildBlock next, Block pending) {
		...
		if (next instanceof TileBuildBlock_1_17_R1){
			...
			NBTTagCompound nmsnbt = (NBTTagCompound) Util_1_17_R1.fromNative(((EntityMap) next).nbt);
