...
public class ConstructorTrait extends Trait implements Toggleable {
	...
	private Location findaspot(Block base){
		...
		for (int a=3; a>=-5;a--){
			if(NMS.getInstance().getUtil().canStand(base.getRelative(0, a, -1))) return  base.getRelative(0, a-1, -1).getLocation();
			if(NMS.getInstance().getUtil().canStand(base.getRelative(0, a, 1))) return  base.getRelative(0, a-1, 1).getLocation();
			if(NMS.getInstance().getUtil().canStand(base.getRelative(1, a, 0))) return  base.getRelative(1, a-1, 0).getLocation();
			if(NMS.getInstance().getUtil().canStand(base.getRelative(-1, a, 0))) return  base.getRelative(-1, a-1, 0).getLocation();
			if(NMS.getInstance().getUtil().canStand(base.getRelative(-1, a, -1))) return  base.getRelative(-1, a-1, -1).getLocation();
			if(NMS.getInstance().getUtil().canStand(base.getRelative(-1, a, 1))) return  base.getRelative(-1, a-1, 1).getLocation();
			if(NMS.getInstance().getUtil().canStand(base.getRelative(1, a, 1))) return  base.getRelative(1, a-1, 1).getLocation();
			if(NMS.getInstance().getUtil().canStand(base.getRelative(1, a, -1))) return  base.getRelative(1, a-1, -1).getLocation();
		}
