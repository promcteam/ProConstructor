            ...
            switch (function) {
                case "on-start": {
                    ...
                    return new Slot(itemStack) {
                        ...
                        public void onLeftClick() {
                            Menu          menu       = this.menu;
                            BaseComponent component  = new TextComponent("▸ Enter the desired action on start, or ");
                            ...
                            component1.setClickEvent(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, current));
                            component.addExtra(component1);
                ...
                case "on-complete": {
                    ...
                    return new Slot(itemStack) {
                        ...
                        public void onLeftClick() {
                            Menu          menu       = this.menu;
                            BaseComponent component  = new TextComponent("▸ Enter the desired action on complete, or ");
                            BaseComponent component1 = new TextComponent(ChatColor.GOLD.toString()+ChatColor.UNDERLINE+"cancel");
                            component1.setClickEvent(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "cancel"));
                            component.addExtra(component1);
                            component.addExtra(new TextComponent(" to go back. "));
                ...
                case "on-cancel": {
                    ...
                    return new Slot(itemStack) {
                        ...
                        public void onLeftClick() {
                            Menu          menu       = this.menu;
                            BaseComponent component  = new TextComponent("▸ Enter the desired action on cancel, or ");
                            BaseComponent component1 = new TextComponent(ChatColor.GOLD.toString()+ChatColor.UNDERLINE+"cancel");
                            component1.setClickEvent(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "cancel"));
                            component.addExtra(component1);
                            component.addExtra(new TextComponent(" to go back. "));
